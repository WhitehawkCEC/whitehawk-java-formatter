...
public final class OpWrapping extends PretendHelper {
  public String asSvg() {
    ...
    return ""
      ...
      + "      <!-- Foo -->"
      + bar(GRAY_200, 100, WIDTH * .48)
      + bar(PRIME_NAVY, value.foo(), WIDTH * .48)
      + "      <!-- Herp -->"
      + bar(GRAY_200, 100, WIDTH * .42)
      + bar(PRIME_BLUE, value.herp(), WIDTH * .42)
      + "      <!-- Bar -->"
      + bar(GRAY_200, 100, WIDTH * .36)
      + bar(PRIME_TEAL, value.bar(), WIDTH * .36)
      + "    </g>"
